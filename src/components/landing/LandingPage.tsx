        ...
        <div className="cta-inner">
          ...
          <div style={{ marginTop: '2.4rem', maxWidth: '460px', width: '100%', margin: '2.4rem auto 0' }}>
            ...
            {waitlistStatus === "success" ? (
              <p style={{ color: 'var(--em)', fontSize: '.85rem', fontWeight: 500 }}>
                You&apos;re on the list. We&apos;ll be in touch.
              </p>
            ) : (
              <form onSubmit={handleWaitlistSubmit} style={{ display: 'flex', gap: '.5rem' }}>
                <input
                  type="email"
            ...
            {waitlistStatus === "error" && (
              <p style={{ color: '#ef4444', fontSize: '.75rem', marginTop: '.4rem' }}>
